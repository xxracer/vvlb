...
import { Loader2, AlertCircle, ArrowRight, Sparkles, User as UserIconSmall, CalendarDays } from 'lucide-react';
  ...
  return (
    <Card className="w-full shadow-xl">
      ...
      {bookingStep === 'selectService' && selectedGender && (
        <>
            <CardHeader>
                <CardTitle className="text-2xl font-headline text-primary">2. Choose Your Service</CardTitle>
